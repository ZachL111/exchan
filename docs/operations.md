...
`exchan` is centered on distributed data work in Elixir. The technical target is: Track CRDT-backed presence state with joins, leaves, and clock merges.
...
The score is deterministic. The current threshold is 172. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 5.
