...
exchan is a Elixir project for distributed data. It focuses on this technical goal: Track CRDT-backed presence state with joins, leaves, and clock merges.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 172, risk penalty 7, latency penalty 2, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
